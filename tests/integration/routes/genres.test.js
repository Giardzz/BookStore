...
describe('/api/genres', () => {
    ...
    describe('PUT /:id', () => {
        ...
        it('should update the genre if id is valid', async () => {
            ...
            const upadatedGenre = await Genre.findById(genre._id);
            expect(upadatedGenre.name).toBe(newName);
        });
    ...
    describe('DELETE /:id', () => {
        ...
        it('should return the deleted genre if it has been deleted', async () => {
            const res = await exec();
